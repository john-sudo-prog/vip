...
function _sfc_render$7(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", _hoisted_1$c, [
    _cache[0] || (_cache[0] = createTextVNode(" 111 ")),
...
function _sfc_render$6(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", _hoisted_1$b, [
    ...
    $setup.isOpen ? (openBlock(), createElementBlock("div", _hoisted_2$a, [
      (openBlock(true), createElementBlock(Fragment, null, renderList($setup.languages, (lang) => {
        return openBlock(), createElementBlock("button", {
          key: lang.code,
          onClick: ($event) => $setup.switchLanguage(lang.code),
          class: normalizeClass(["flex items-center w-full px-3 py-2 text-sm text-gray-200 hover:bg-gray-700/50 transition-colors duration-200", { "bg-gray-700/50": $setup.currentLocale === lang.code }])
        }, [
          createBaseVNode("span", _hoisted_4$a, toDisplayString(lang.name), 1),
          $setup.currentLocale === lang.code ? (openBlock(), createElementBlock("svg", _hoisted_5$a, _cache[2] || (_cache[2] = [
            createBaseVNode("path", {
              "stroke-linecap": "round",
              "stroke-linejoin": "round",
              "stroke-width": "2",
...
const LanguageSwitcher = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["render", _sfc_render$6]]);
